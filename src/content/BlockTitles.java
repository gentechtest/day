...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
		 @Test(priority=3, description="Проверяет отображение имен блоков на  <<Азербайджанская>>")
		 public void AzerTitles () throws Exception {
			 ...
			 try{
				 driver.findElement(By.xpath("//h3[contains(text(),'Топ-10 азербайджанских песен за неделю')]")).isDisplayed();
				    ...
				    System.out.println("На странице "+driver.getCurrentUrl()+" неторображается имя блока <<Топ-10 азербайджанских песен за неделю>>");
			    	Reporter.log("На странице "+driver.getCurrentUrl()+" неторображается имя блока <<Топ-10 азербайджанских песен за неделю>>");
			  		throw new NoSuchElementException (""); 
			 }
